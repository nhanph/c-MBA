...
class AdvMADDPGLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        # print('aaa',inputs.shape, actions.shape, rewards.shape, terminated.shape)
        # torch.Size([256, 17]) torch.Size([256, 1, 2, 3]) torch.Size([256, 1, 1]) torch.Size([256, 1, 1])
        ...
        # print('aaa',actions.shape, target_actions.shape, q_taken.shape, rewards.shape, agent_target_outs.shape)
        ...
        # print('ccc',pi.shape, pi.view(batch.batch_size,self.n_agents,-1).shape)
