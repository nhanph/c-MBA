...
CONFIG="pgd_lr=0.5 pgd_step=30 plan_step=1 test_nepisode=50 \
		dynamic_model_path="""results/dynamic_models/Ant_4x2/model_200K_ant_4x2_211110_AdamW_lr1e-05_epoch1.pt""" \
...
for agent in 0 1 2 3
  do
	NAME=maddpg_model_atk_linf_norm_ant_4x2_agent${agent}_model200K_epoch1
